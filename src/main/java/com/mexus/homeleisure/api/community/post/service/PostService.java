package com.mexus.homeleisure.api.community.post.service;
...
import com.mexus.homeleisure.api.community.post.dto.PostDetailDto;
import com.mexus.homeleisure.api.community.post.dto.PostsDto;
...
import com.mexus.homeleisure.api.community.post.exception.PostNotFoundException;
import com.mexus.homeleisure.api.community.post.request.ModifyPostRequest;
...
public class PostService {
    ...
    public Long savePost(String requestUserId, ModifyPostRequest modifyPostRequest) {
        return this.postRepository.save(
                new Post(
                        null,
                        usersRepository.findByUserIdAndState(requestUserId, UserStatus.NORMAL, Users.class).orElseThrow(
