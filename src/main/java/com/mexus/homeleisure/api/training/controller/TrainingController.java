...
public class TrainingController {
    ...
    public PagedModel<TrainingsResponse> getTrainings(
        ...
        Page<TrainingsDto> trainings = this.trainingService.getTrainings(pageable);
        PagedModel<TrainingsResponse> trainingsResponses = assembler.toModel(trainings, trainingsDto -> new TrainingsResponse(
            trainingsDto));
    ...
    public LinksResponse savetraining(
        ...
        response.setHeader("Location", linkTo(TrainingController.class).slash(trainingId).toUri().toString());
    ...
    public TrainingResponse gettraining(
        ...
        if (SecurityContextHolder.getContext().getAuthentication().getName().equals(training.getWriterId())) {
            trainingResponse.add(linkTo(TrainingController.class).slash(trainingId).withRel("updateTraining"));
            trainingResponse.add(linkTo(TrainingController.class).slash(trainingId).withRel("deleteTraining"));
        }
