...
public class TrainingService {
    ...
    public TrainingDetailDto getTraining(Long trainingId) {
        ...
        return TrainingDetailDto.builder()
                ...
                .writerId(training.getAuthor().getUserId())
     ...
     */
    @Transactional
    public void updateTraining(Long trainingId, String requestUserId, ModifyTrainingRequest modifyTrainingRequest) {
    ...
    private Training getMyTraining(Long trainingId, String requestUserId) {
        return trainingRepository.findByTrainingIdAndAuthor_UserId(trainingId, requestUserId)
