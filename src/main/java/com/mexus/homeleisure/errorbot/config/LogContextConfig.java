package com.mexus.homeleisure.errorbot.config;

import ch.qos.logback.classic.LoggerContext;
import com.mexus.homeleisure.errorbot.ErrorLogsRepository;
import com.mexus.homeleisure.errorbot.ErrorReportAppender;
import com.mexus.homeleisure.errorbot.filter.CollectRequestDataFilter;
import com.mexus.homeleisure.errorbot.filter.MultiReadableHttpServletRequestFilter;
...
public class LogContextConfig implements InitializingBean {
    ...
    public void afterPropertiesSet() {
        ...
        ErrorReportAppender
            errorReportAppender = new ErrorReportAppender(logConfig, errorLogsRepository);
