        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.get("/trainings")
                ...
                .andDo(document("getTrainings",
                        responseFields(
                                ...
                                fieldWithPath("_embedded.trainingList[].writerId").description("작성자 아이디"),
                                fieldWithPath("_embedded.trainingList[].views").description("조회수"),
                                fieldWithPath("_embedded.trainingList[].commentNum").description("댓글수"),
                                fieldWithPath("_embedded.trainingList[].modifiedDate").description("수정일"),
                                fieldWithPath("_embedded.trainingList[]._links.self.href").description("트레이닝 데이터 링크"),
